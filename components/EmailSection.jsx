        ...
        <main className="grid md:grid-cols-2 my-12 md:my-12 py-24 md:py-24 gap-4 relative" id="contact">
            ...
            <h5 className="text-4xl font-bold my-2 bg-gradient-to-r from-teal-500 to-teal-100 text-transparent bg-clip-text">Let's Connect</h5>
                ...
                <div className=" flex flex-row gap-4 mt-6">
                    <Link href="https://github.com/Sauyang520">
                        <Image src={GithubIcon} alt="Github Icon" />
                    </Link>
                    <Link href="https://www.linkedin.com/in/sau-yang-sim-034831272">
                        <Image src={LinkedinIcon} alt="Linkedin Icon" />
                    </Link>
                    <Link href="https://www.instagram.com/sauyang______/" className="mt-1">
                        <Image src={InstagramIcon}/>
                    </Link>
                    <Link href="mailto:sauyang0308@gmail.com" className="mt-1">
                        <Image src={GmailIcon}/>
                    </Link>
